...
const stats = [
  { value: 500, suffix: 'k+', label: 'Shared moments and stories every month' },
  { value: 200, suffix: 'k+', label: 'Communities thriving across diverse interests' },
  { value: 50, suffix: '+', label: 'Countries where Appit is growing strong' },
]
